...
- [ ] **FLEx → Table** — segmented words (`vu=ve`, `levo-z`) collapse into a single cell with morphemes joined inline
- [ ] **FLEx → Table** — glosses assembled inline per word (`fox=ERG`, `follow.CMP`) matching the morpheme structure
