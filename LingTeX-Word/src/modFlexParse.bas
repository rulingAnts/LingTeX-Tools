...
' attached as a PREFIX on its morpheme ("=de", not a standalone "=" column);
...
'        in: FLEx spreads "attack" and ".CMP" over two columns but both belong
'        to the single morpheme "deda".
...
' so "bi" followed by ":" becomes the single form "bi:" with its gloss intact.
