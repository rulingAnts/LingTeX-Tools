...
| Grammatical glosses (`SEQ`, `ERG`, `FOC`, `3SG`) render as **small capitals**; lexical glosses (`yam`, `pick`, `stack`) do not | ☐ | ☐ |
...
| `ze:` — the colon is attached to the preceding form, not given its own column | ☐ | ☐ |
