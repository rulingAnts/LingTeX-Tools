 ...
 *          folded in (FLEx spreads `attack` `.CMP` over two columns; both
 *          belong to the single morpheme `deda`)
 *
 ...
 * `bi` followed by `:` becomes the single form `bi:` with the gloss untouched.
